...
Settings.Wave.Amplitude = [5,0.25:0.25:20];  %unique([5,1:1:5],'stable'); %K
Settings.Wave.Lambdax   = [500,30:5:100,150:50:400,500:100:1000];%km - across track
Settings.Wave.Lambday   = [1000,25:25:1500]; %km - along track
Settings.Wave.Lambdaz   = [25,1:1:100];  %km
Settings.Wave.Rotationx = [0:10:170];        %degrees in x to rotate wave
Settings.Wave.Rotationy = [0:10:170];        %degrees in y to rotate wave
Settings.Wave.Rotationz = [0:10:170];        %degrees in z to rotate wave
