...
Settings.Plotting.ZLevel = 39; %km

%latitude and longitude box
Settings.Plotting.LatRange = [-70,-30];
Settings.Plotting.LonRange = [-95,-50];

%cross-track row to plot
Settings.Plotting.XTRow = 40 .*Settings.InterpFactor(1);

%along track elements to plot
Settings.Plotting.ATEls = (75:1:250) .*Settings.InterpFactor(1);
...
clf
set(gcf,'color','w')
subplot = @(m,n,p) subtightplot (m, n, p, [0.03,0.02], 0.05, [0.05 0.01]);
